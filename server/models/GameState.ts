...
const MY_ID = "61e4e1bf335ba570cd3f5f6a";
const MY_TEAM = 0;
const START_TOWER_ID = 0;
const START_TOWER: Tower = {
  health: 50,
  location: { x: 500, y: 500 },
  size: Size.Small,
  enemyMinionIds: [],
};
const MY_PLAYER: Player = {
  gold: 50,
  towerIds: [START_TOWER_ID],
  minionIds: [],
...
export const gameState: Record<number, GameState> = {
  0: {
    timer: new Date(),
    winnerId: null,
    towers: { [START_TOWER_ID]: START_TOWER },
    maxTowerId: 0,
    minions: {},
    maxMinionId: 0,
    players: { [MY_ID]: MY_PLAYER },
    playerToTeamId: { [MY_ID]: MY_TEAM },
  },
};
